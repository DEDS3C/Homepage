...
(lib.animation01 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(310).to({alpha:1},0).wait(150));

	// speech bubble
	this.instance_2 = new lib.Symbol1();
	this.instance_2.setTransform(70,140,1,1,0,0,0,60,8.5);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(30).to({alpha:1},0).wait(257).to({alpha:0},0).wait(173));
	...
	this.instance_9.setTransform(20.8,3);
