...
(lib.packet4 = function() {
	...
	this.text_12.setTransform(63,22);
...
(lib.packet3 = function() {
	...
	this.text_13.setTransform(60,22);//3rd envelope
...
(lib.packet2 = function() {
	...
	this.text_14.setTransform(63,22); //2nd envelope
...
(lib.packet = function() {
	...
	this.text_15.setTransform(60,22); // 1st envelope
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{},true);
	...
	this.text_16.setTransform(379,144.3);
