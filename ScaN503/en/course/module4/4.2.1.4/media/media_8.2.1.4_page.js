...
(slideViewDidLoad = function(container,id){	
	...
	function initSlide(){
	var textArray = [
		{compId:"ID_s1_txt13", x:"-7" ,y:"200", width:"98", expand:"up+down", align:"center", size:"10"},
		...
		{compId:"ID_s1_txt24", x:"130", y:"247", width:"180", expand:"right", align:"left" ,size:"10" ,class:"orangeCallOut"}
