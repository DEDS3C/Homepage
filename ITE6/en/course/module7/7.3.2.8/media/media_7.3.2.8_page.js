...
btn = getCJSElement("IMAGE",{x:btnXPosArr[i],y:btnYPosArr[i],width:45,height:55.70,src:"plus_btn.png",});

buttonArr.push(btn);
container.addChild(btn);

btn1 = getCJSElement("IMAGE",{x:btnXPosArr[i],y:btnYPosArr[i],width:45,height:55.70,src:"plus_btn_over.png",});

buttonOverArr.push(btn1);
container.addChild(btn1);
btn1.visible=false;

btn4 = getCJSElement("IMAGE",{x:btnXPosArr[i]+5,y:btnYPosArr[i]+3,width:32.5,height:32.5,src:"plus_btn_over2.png",});
